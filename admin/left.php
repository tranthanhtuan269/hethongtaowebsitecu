...
if(defined('iS_ADMIN')) {
	...
	echo "	<tr>\n";
	echo "		<td align=\"center\" style=\"padding-top: 3px\" height=\"30\"><a href=\"javascript:slash_contractall()\" class=\"catmenu\"><font color=\"#FFFFFF\">"._CLOSE."</font> <img border=\"0\" src=\"images/bullet.gif\" align=\"absmiddle\"></a> <a href=\"javascript:slash_expandall()\" class=\"catmenu\"><img  align=\"absmiddle\" border=\"0\" src=\"images/bullet1.gif\"> <font color=\"#FFFFFF\">"._OPEN."</font></a></td>\n";
	echo "	</tr>\n";
	echo "</table>\n";
	echo "<div class=\"sdmenu\">\n";


	$result = $db->sql_query_simple("SELECT * FROM ".$prefix."_admin_menu where action = '1' ORDER BY weight");
