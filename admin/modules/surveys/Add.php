...
if(isset($_POST['subup']) && $_POST['subup'] == 1) {
	...
	if(!$err) {
		...
		$db->sql_query_simple("INSERT INTO ".$prefix."_survey (id, question, votes, anwsers, options, time, alanguage) VALUES(NULL, '$title', '$votes_up', '$anwsers_up', '".sizeof($anwsers_vl)."', '".time()."', '$currentlang')");
