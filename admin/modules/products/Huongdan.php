...
$result = $db->sql_query_simple("SELECT content FROM ".$prefix."_huongdan WHERE alanguage='$currentlang'");
...
if(isset($_POST['submit']) && $_POST['submit'] !="") {
	...
	if($db->sql_numrows($result) > 0) {
		$db->sql_query_simple("UPDATE ".$prefix."_huongdan SET content='$content' WHERE alanguage='$currentlang'");
	}else{
		$db->sql_query_simple("INSERT INTO ".$prefix."_huongdan VALUES ('$content', '$currentlang')");
	}	
