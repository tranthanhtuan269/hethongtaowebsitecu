...
$countf = $db->sql_fetchrow_simple($db->sql_query_simple("SELECT COUNT(*) FROM ".$prefix."_products WHERE alanguage='$currentlang' AND pnews='1'"));
$total = ($countf[0]) ? $countf[0] : 1;
$result = $db->sql_query_simple("SELECT id, title, time, active, hits FROM ".$prefix."_products WHERE pnews='1' AND alanguage='$currentlang' $sortby LIMIT $offset,$perpage");
if($db->sql_numrows($result) > 0) {
	...
	echo "<br><table align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\" class=\"tableborder table table-bordered\">\n";
