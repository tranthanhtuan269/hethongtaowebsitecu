...
$active = 1;
$title = $catid = $hometext = $bodytext = $imgtext = $source = $startid = $imgshow = $err_cat = $err_title = $images = '';
if( isset($_POST['subup']) && $_POST['subup'] == 1) {
	...
	if (!$err) {
		...
		$query = "INSERT INTO $insertIntoTable (id, catid, title, alanguage, hometext, bodytext, images, imgtext, active, source, imgshow, image_highlight, hits, nstart";
		if ($timed) $query .= ', timed';
		else $query .= ', time';
		$query .= ") VALUES ($id, $catid, '$title', '$currentlang', '$hometext', '$bodytext', '$images', '$imgtext', $active, '$source', $imgshow, $highlight, 0, $startid";
...
echo "<td class=\"row2\">";
editor("hometext",$hometext);
echo "</td>\n";
echo "</tr>\n";
echo "<tr>\n";
echo "<td align=\"right\" class=\"row1\"><b>"._BODYTEXT."</b></td>\n";
echo "<td class=\"row2\">";
editor("bodytext", $bodytext,"",300);
echo "</td>\n";
echo "</tr>\n";
echo "<tr>\n";
