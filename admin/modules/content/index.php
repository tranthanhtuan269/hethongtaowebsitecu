...
if($db->sql_numrows($result) > 0) {
	...
	while(list($id, $catid, $title, $time, $active, $hits, $nstart, $newsType) = $db->sql_fetchrow_simple($result)) {
		...
		if($ajax_active == 1) {
			switch($active) {
				case 1: $active = "<a href=\"?f=".$adm_modname."&do=status_news&type=$newsType&id=$id&stat=0\" title=\""._DEACTIVATE."\" onclick=\"ajaxinfoget('modules.php?f=news&do=status_news&type=$newsType&id=$id&stat=0&load_hf=1','ajaxload_container', 'news_main'); return false;\"><img border=\"0\" src=\"images/view.png\"></a>"; break;
				case 0: $active = "<a href=\"?f=".$adm_modname."&do=status_news&type=$newsType&id=$id&stat=1\" title=\""._ACTIVE."\" onclick=\"ajaxinfoget('modules.php?f=news&do=status_news&type=$newsType&id=$id&stat=1&load_hf=1','ajaxload_container', 'news_main'); return false;\"><img border=\"0\" src=\"images/viewo.png\"></a>"; break;
			}
			switch($nstart) {
				case 1: $nstart = "<a href=\"?f=".$adm_modname."&do=news_start&type=$newsType&id=$id&stat=0\" info=\""._NOSTART."\" onclick=\"ajaxinfoget('modules.php?f=news&do=news_start&type=$newsType&id=$id&stat=0','ajaxload_container','news_main'); return false;\"><img border=\"0\" src=\"../images/red_dot.gif\"></a>"; break;
				case 0: $nstart = "<a href=\"?f=".$adm_modname."&do=news_start&type=$newsType&id=$id&stat=1\" info=\""._YESSTART."\" onclick=\"ajaxinfoget('modules.php?f=news&do=news_start&type=$newsType&id=$id&stat=1','ajaxload_container','news_main'); return false;\"><img border=\"0\" src=\"../images/green_dot.gif\"></a>"; break;
			}
		} else {
			switch($active) {
			...
			switch($nstart) {
				case 1: $nstart = "<a href=\"?f=".$adm_modname."&do=news_start&type=$newsType&id=$id&stat=0\" info=\""._NOSTART."\"><img border=\"0\" src=\"../images/red_dot.gif\"></a>"; break;
				case 0: $nstart = "<a href=\"?f=".$adm_modname."&do=news_start&type=$newsType&id=$id&stat=1\" info=\""._YESSTART."\"><img border=\"0\" src=\"../images/green_dot.gif\"></a>"; break;
			}
		}
		...
		if ($newsType == 'normal') $titleLink = "<a href=\"../".url_sid("index.php?f=".$adm_modname."&do=detail&id=$id")."\" info=\""._GETLINK."\" onclick=\"prompt('"._GETLINK."','".url_sid("index.php?f=$adm_modname&do=detail&id=$id")."'); return false;\"><img border=\"0\" src=\"images/link.png\"></a> <a href=\"".RPATH.url_sid("index.php?f=".$adm_modname."&do=detail&id=$id")."\" info=\""._VIEW."\" target=\"_blank\">$title</a>";
	...
	if($total > $perpage) {
		...
		$pageurl = "".$adm_modname.".php?f=".$adm_modname."&sort=$sort";
