...
$id = intval($_GET['id']);
$result = $db->sql_query_simple("SELECT images FROM ".$prefix."_advertise_scroll WHERE id='$id'");
...
$db->sql_query_simple("DELETE FROM ".$prefix."_advertise_scroll WHERE id='$id'");
fixweight_scroll();
