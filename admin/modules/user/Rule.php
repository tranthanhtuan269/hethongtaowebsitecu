...
$result = $db->sql_query_simple("SELECT content FROM ".$prefix."_rule WHERE alanguage='$currentlang'");
...
if(isset($_POST['submit']) && $_POST['submit'] !="") {
	...
	if($db->sql_numrows($result) > 0) {
		$db->sql_query_simple("UPDATE ".$prefix."_rule SET content='$content' WHERE alanguage='$currentlang'");
	}else{
		$db->sql_query_simple("INSERT INTO ".$prefix."_rule VALUES ('$content', '$currentlang')");
	}	
