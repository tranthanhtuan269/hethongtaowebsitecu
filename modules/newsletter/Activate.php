...
if (isset($_GET['code'])) {
	$db->sql_query_simple("UPDATE {$prefix}_newsletter SET activateCode=NULL WHERE activateCode='".$escape_mysql_string($_GET['code'])."' AND email='".$escape_mysql_string($_GET['email'])."'");
