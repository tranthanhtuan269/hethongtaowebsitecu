...
$query = "SELECT id, title, content, time, name, email,hits FROM ".$prefix."_question WHERE active=1 AND alanguage='$currentlang' ORDER BY time DESC LIMIT $offset, $perpage";
