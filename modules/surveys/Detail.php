...
$id = intval($_GET['id']);
$result = $db->sql_query_simple("SELECT question, votes, anwsers, options, totalvotes FROM ".$prefix."_survey WHERE id='$id' AND active='1' AND alanguage='$currentlang'");
...
list($title, $votes, $anwsers, $options, $totalvotes) = $db->sql_fetchrow_simple($result);
